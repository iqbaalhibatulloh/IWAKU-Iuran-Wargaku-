...
<div class="col-span-3">
    ...
    <div class="col-span-3 shadow-2xl rounded-xl mx-7 bg-[#4C3B2A] mt-10 h-72 px-2 mb-7 overflow-y-auto relative">
        <div class="sticky top-0 bg-[#4C3B2A] z-10">
        <h2 class="border-b-2 sticky top-0">Iuran THR</h2>
        <h2 class="text-xl">Data yang belum bayar iuran bulan THR</h2>
    </div>
    <div class="w-full px-7 my-5 pb-7 overflow-y-auto text-sm">
        <table id="exampleeee" class="display" style="width:100%" class="">
            <thead>
                <tr>
                    <th>No</th>
                    <th>ID</th>
