...
<div class="mt-7 mx-7 col-span-3 text-center">
    <a class="" href="{{ \route('document.detailDocPemasukan') }}">
...
<div class=" flex col-span-3 relative mx-5 h-48  "> 
    <a href="detailDocPemasukan" class="w-full rounded-xl bg-[#4C3B2A] m-1 py-2 items-center justify-center text-center flex px-2">
        <button type="" method="" >
            Iuran Bulanan 
        </button>   
    </a>
    <a href="#" class="w-full rounded-xl bg-[#4C3B2A] m-1 py-2 items-center justify-center text-center flex px-2">
        <button type="" method="" >
            Iuran Ronda 
        </button>
    </a>
