...
<div class="mt-7 mx-7 col-span-3 text-center">
    <a class="" href="{{ route("document.detailDoc") }}">
...
<div class=" flex col-span-3 relative mx-5 h-48  "> 
    <a href="{{ route("document.detailDocPemasukan", "Bulanan") }}" class="w-full rounded-xl bg-[#4C3B2A] m-1 py-2 items-center justify-center text-center flex px-2">
        <button type="" method="" >
            Iuran Bulanan 
        </button>   
    </a>
    <a href="{{ route("document.detailDocPemasukan", "Ronda") }}" class="w-full rounded-xl bg-[#4C3B2A] m-1 py-2 items-center justify-center text-center flex px-2">
        <button type="" method="" >
            Iuran Ronda 
        </button>
    </a>
...
<div class=" flex col-span-3 relative mx-5 mb-7 h-48"> 
    <a href="{{ route("document.detailDocPemasukan", "Sampah") }}" class="w-full rounded-xl bg-[#4C3B2A] m-1 py-2 items-center justify-center text-center flex px-2">
        <button type="" method="" >
            Iuran Sampah 
        </button>
    </a>
    <a href="{{ route("document.detailDocPemasukan", "THR") }}" class="w-full rounded-xl bg-[#4C3B2A] m-1 py-2 items-center justify-center text-center flex px-2">
        <button type="" method="" >
            Iuran THR 
        </button>
    </a>
