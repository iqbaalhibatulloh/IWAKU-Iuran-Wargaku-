                  ...
                  @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        <div class="col-span-2 sm:col-span-1">
                            ...
                            <select name="alamat" id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                              <option selected disabled>Alamat</option>
                              <option value="TV">RT 01</option>
                              <option value="TV">RT 02</option>
                              <option value="TV">RT 03</option>
                              <option value="TV">RT 04</option>
                              <option value="TV">RT 05</option>
                          </select>
                        </div>
                        <div class="col-span-2 sm:col-span-1">
...
<div class="col-span-3">
  @for ($i = 1; $i <= 5; $i++)
  <a href="{{route('memberList.show.byrt', "RT0" . $i)}}" class="block col-span-3 shadow-2xl rounded-xl mb-10 mx-7 bg-[#4C3B2A] text-center ">
      <button>
        <h2 class="py-20">RT0{{$i}}</h2>
      </button>    
  </a>
  @endfor
</div>
