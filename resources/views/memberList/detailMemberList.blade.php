...
<div class="col-span-3 h-[630px]">
    ...
    <div class="col-span-3 shadow-2xl rounded-xl mx-7 bg-[#4C3B2A] mt-10 max-h-[460px] px-2 overflow-y-auto relative mb-7">
        <div class=" ">
<!-- Modal toggle -->
...
<button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 " type="button">
                ...
                @csrf
                  <div class="grid gap-4 mb-4 grid-cols-2">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                      ...
                      <input type="hidden" name="alamat" value="{{$wargas->first()->alamat}}">
  ...
  <!-- Modal toggle -->
            {{-- <button class="rounded bg-[#0084E4] p-1 mr-5 text-xl">
                Tambah User
              </button> --}}
        </div>
                ...
                <tbody class="">
                   ...
                   <tr>
                    ...
                    <td class="flex gap-3 justify-center">
                        ...
                        <a href="{{ route('memberList.editMemberList') }}">
