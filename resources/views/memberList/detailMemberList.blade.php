...
@section('content')
<div class="col-span-3 max-h-[900px]">
    <div class="mt-3 mx-7 col-span-3 text-center">
 ...
 <div class="flex justify-end m-7">
                ...
                <form class="p-4 md:p-5" action="{{route("warga.store")}}" method="POST">
                  @csrf
                    <div class="grid gap-4 mb-4 grid-cols-2">
                        ...
                        {{-- DIBIKIN INPUT DENGAN TYPE HIDDEN --}}
                        ...
                        <input type="hidden" name="rw" value="{{ auth()->user()->rw != "" ? auth()->user()->rw : auth()->user()->role  }}" >
                        {{-- <div class="col-span-2 sm:col-span-1">
    ...
    </div>        {{-- <button class="rounded bg-[#0084E4] p-1 mr-5 text-xl">
                Tambah User
              </button> --}}
        </div>
        <div class="w-full px-7 h-max my-5 overflow-y-auto text-sm text-center">
                ...
                <tbody class="">
                   ...
                   <tr>
                    ...
                    <td class="flex gap-3 justify-center">
                        <a href="{{ route('payment.opsiPayment', $item) }}">
                        <button class="flex justify-center rounded-lg bg-blue-500 w-10 h-5 items-center">
                            <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" ><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <g clip-path="url(#clip0_15_200)"> <rect width="24" height="24"></rect> <circle cx="12" cy="13" r="2" stroke="#fff" stroke-linejoin="round"></circle> <path d="M12 7.5C7.69517 7.5 4.47617 11.0833 3.39473 12.4653C3.14595 12.7832 3.14595 13.2168 3.39473 13.5347C4.47617 14.9167 7.69517 18.5 12 18.5C16.3048 18.5 19.5238 14.9167 20.6053 13.5347C20.8541 13.2168 20.8541 12.7832 20.6053 12.4653C19.5238 11.0833 16.3048 7.5 12 7.5Z" stroke="#fff" stroke-linecap="round" stroke-linejoin="round"></path> </g> <defs> <clipPath id="clip0_15_200"> <rect width="24" height="24" fill="white"></rect> </clipPath> </defs> </g></svg>
                        </button>
                        </a>
                        <a href="{{ route('memberList.editMemberList', $item) }}">
                        <button class="flex justify-center rounded-lg bg-[#F7CF00] w-10 h-5 items-center">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M2 12C2 16.714 2 19.0711 3.46447 20.5355C4.92893 22 7.28595 22 12 22C16.714 22 19.0711 22 20.5355 20.5355C22 19.0711 22 16.714 22 12V10.5M13.5 2H12C7.28595 2 4.92893 2 3.46447 3.46447C2.49073 4.43821 2.16444 5.80655 2.0551 8" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> <path d="M16.652 3.45506L17.3009 2.80624C18.3759 1.73125 20.1188 1.73125 21.1938 2.80624C22.2687 3.88124 22.2687 5.62415 21.1938 6.69914L20.5449 7.34795M16.652 3.45506C16.652 3.45506 16.7331 4.83379 17.9497 6.05032C19.1662 7.26685 20.5449 7.34795 20.5449 7.34795M16.652 3.45506L10.6872 9.41993C10.2832 9.82394 10.0812 10.0259 9.90743 10.2487C9.70249 10.5114 9.52679 10.7957 9.38344 11.0965C9.26191 11.3515 9.17157 11.6225 8.99089 12.1646L8.41242 13.9M20.5449 7.34795L17.5625 10.3304M14.5801 13.3128C14.1761 13.7168 13.9741 13.9188 13.7513 14.0926C13.4886 14.2975 13.2043 14.4732 12.9035 14.6166C12.6485 14.7381 12.3775 14.8284 11.8354 15.0091L10.1 15.5876M10.1 15.5876L8.97709 15.9619C8.71035 16.0508 8.41626 15.9814 8.21744 15.7826C8.01862 15.5837 7.9492 15.2897 8.03811 15.0229L8.41242 13.9M10.1 15.5876L8.41242 13.9" stroke="#ffffff" stroke-width="1.5" stroke-linecap="round"></path> </g></svg>
                        </button>
                        </a>
                        <form id="deleteForm" action="{{ route("warga.destroy", $item) }}" method="POST">
                            @csrf
                            @method("DELETE")
                            <button id="delete-btn" class="flex justify-center rounded-lg bg-[#E40000] w-10 h-5 items-center">
