...
<div class="col-span-3 max-h-[900px]">
 ...
 <div class="flex justify-end">
    <button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 " type="button">
                  ...
                  <form class="p-4 md:p-5" action="{{route("warga.store")}}" method="POST">
                    @csrf
                      <div class="grid gap-4 mb-4 grid-cols-2">
                          ...
                          {{-- <input type="hidden" name="rt" value="@isset($warga){{$wargas->first()->rt}} @endisset"> --}}
                          {{-- <input type="hidden" name="rt" value="@isset($warga){{$wargas->where('rw',auth()->user()->role)}} @endisset"> --}}
                          {{-- <div class="col-span-2 sm:col-span-1">
      ...
      <!-- Modal toggle -->            {{-- <button class="rounded bg-[#0084E4] p-1 mr-5 text-xl">
                Tambah User
              </button> --}}
        </div>
                ...
                <tbody class="">
                   ...
                   <tr>
                    ...
                    <td class="flex gap-3 justify-center">
                        <a href="{{ route('payment.opsiPayment') }}">
                        ...
                        <button class="flex justify-center rounded-lg bg-[#E40000] w-10 h-5 items-center">
