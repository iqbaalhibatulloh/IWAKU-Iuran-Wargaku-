...
<div class="col-span-3">
    ...
    <div class="col-span-3 shadow-2xl rounded-xl mx-7 bg-[#4C3B2A] mt-10 h-72 px-2 overflow-y-auto relative mb-7">
        <div class=" m-2">
...
<button type="button" data-modal-target="crud-modal" data-modal-toggle="crud-modal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 " type="button">
                  ...
                  <div class="grid gap-4 mb-4 grid-cols-2">
                      ...
                      <div class="col-span-2 sm:col-span-2">
                          ...
                          <select id="category" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            ...
                            <option value="">Menetap</option>
                            <option value="TV">Ngontrak</option>
                        </select>
                      </div>
  ...
  <!-- Modal toggle -->
        ...
        <div class="w-full px-7 my-5 overflow-y-auto text-xl">
                ...
                <tbody>
                   ...
                   <tr>
                    ...
                    <td class="flex gap-3 justify-center">
                        <button class="flex justify-center rounded-lg bg-green-600 w-16 h-9 items-center">
                    ...
                    <button class="flex justify-center rounded-lg bg-[#F7CF00] w-16 h-9 items-center">
                    ...
                    <button class="flex justify-center rounded-lg bg-[#E40000] w-16 h-9 items-center">
