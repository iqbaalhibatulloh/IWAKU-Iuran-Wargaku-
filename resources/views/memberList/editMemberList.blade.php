...
<div class="col-span-3"> 
    <div class="col-span-3 shadow-2xl rounded-xl mx-7 mb-7 bg-[#4C3B2A] mt-10 px-7 py-5 h-96 ">
        <a class="" href="{{route('memberList.show.byrt', $warga->rt)}}">
         ...
         <form class="p-4 md:p-5" action="{{route("memberList.update")}}" method="POST">
          @csrf
            <div class="grid gap-4 mb-4 grid-cols-2">
              <div class="col-span-1">
                  <label for="name" class="block mb-2 text-sm font-medium text-white dark:text-white">ID</label>
              ...
              <div class="col-span-2 sm:col-span-1">
                  <label for="price" class="block mb-2 text-sm font-medium text-white dark:text-white">Nama</label>
              ...
              <div class="col-span-2 sm:col-span-1">
                <label for="category" class="block mb-2 text-sm font-medium text-white dark:text-white">RT</label>
            ...
            {{-- {{ dd($warga->rw) }} --}}
            <div class="col-span-2 sm:col-span-1">
              <label for="category" class="block mb-2 text-sm font-medium text-white dark:text-white">RW</label>
          ...
          <div class="col-span-2 sm:col-span-1">
            <label for="category" class="block mb-2 text-sm font-medium text-white dark:text-white">Status</label>
